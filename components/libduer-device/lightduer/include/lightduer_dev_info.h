...
/*
 * Get the Duer OS version of the current system
 *
 * @param duer_os_version: size > DUER_OS_VERSION_LEN
 *
 * @return int: Success: DUER_OK
 *              Failed:  Other
 */
extern int duer_get_duer_os_version(char *duer_os_version);
